...
var (
	...
	reTokenish = regexp.MustCompile(`(?i)\b(GH_TOKEN|GITHUB_TOKEN|sk-[A-Za-z0-9_-]{10,}|xox[baprs]-[A-Za-z0-9-]{10,}|Bearer\s+[A-Za-z0-9._\-]{12,}|gh[pousr]_[A-Za-z0-9]{20,}|github_pat_[A-Za-z0-9_]{20,})\b`)
)
